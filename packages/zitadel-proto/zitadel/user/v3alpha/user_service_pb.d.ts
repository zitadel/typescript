...
import type { Details, ListDetails, ListQuery, Organization } from "../../object/v2beta/object_pb.js";
import type { FieldName, SearchQuery } from "./query_pb.js";
import type { User } from "./user_pb.js";
import type { AuthenticatorRegistrationCode, IdentityProviderIntent, IDPAuthenticator, IDPInformation, LDAPCredentials, RedirectURLs, ReturnPasswordResetCode, ReturnWebAuthNRegistrationCode, SendPasswordResetEmail, SendPasswordResetSMS, SendWebAuthNRegistrationLink, SetAuthenticators, SetPassword, SetUsername, WebAuthNAuthenticatorType } from "./authenticator_pb.js";
import type { ReturnEmailVerificationCode, ReturnPhoneVerificationCode, SendEmailVerificationCode, SendPhoneVerificationCode, SetContact, SetEmail, SetPhone } from "./communication_pb.js";
