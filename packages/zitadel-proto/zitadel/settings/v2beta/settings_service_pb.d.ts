...
import type { PasswordComplexitySettings, PasswordExpirySettings } from "./password_settings_pb.js";
 ...
 */
export declare class GetPasswordExpirySettingsRequest extends Message<GetPasswordExpirySettingsRequest> {
  /**
   * @generated from field: zitadel.object.v2beta.RequestContext ctx = 1;
   */
  ctx?: RequestContext;
 ...
 */
export declare class GetPasswordExpirySettingsResponse extends Message<GetPasswordExpirySettingsResponse> {
  /**
   * @generated from field: zitadel.object.v2beta.Details details = 1;
   */
  details?: Details;
