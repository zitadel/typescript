...
export declare const SettingsService: {
  ...
  readonly methods: {
    ...
    readonly getPasswordExpirySettings: {
      ...
      readonly I: typeof GetPasswordExpirySettingsRequest,
      readonly O: typeof GetPasswordExpirySettingsResponse,
      readonly kind: MethodKind.Unary,
    },
    /**
