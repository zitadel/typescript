...
import { SetRESTRequestResponse, SetRESTWebhook, Target } from "./target_pb.js";
...
import { Condition, Execution } from "./execution_pb.js";
...
export const CreateTargetRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "rest_request_response", kind: "message", T: SetRESTRequestResponse, oneof: "target_type" },
    { no: 4, name: "timeout", kind: "message", T: Duration },
    { no: 5, name: "is_async", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "execution_type" },
    { no: 6, name: "interrupt_on_error", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "execution_type" },
  ],
);
...
export const UpdateTargetRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "rest_request_response", kind: "message", T: SetRESTRequestResponse, oneof: "target_type" },
    { no: 5, name: "timeout", kind: "message", T: Duration, opt: true },
    { no: 6, name: "is_async", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "execution_type" },
    { no: 7, name: "interrupt_on_error", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "execution_type" },
  ],
);
...
export const SetExecutionRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "includes", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ],
);
