...
export const LoginCustomText = {
  encode(message: LoginCustomText, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.linkingUserPromptText !== undefined) {
      LinkingUserPromptScreenText.encode(message.linkingUserPromptText, writer.uint32(298).fork()).ldelim();
    }
    return writer;
  },
  ...
  toJSON(message: LoginCustomText): unknown {
    ...
    message.externalRegistrationUserOverviewText !== undefined &&
      (obj.externalRegistrationUserOverviewText = message.externalRegistrationUserOverviewText
        ...
        : undefined);
    message.isDefault !== undefined && (obj.isDefault = message.isDefault);
    message.linkingUserPromptText !== undefined && (obj.linkingUserPromptText = message.linkingUserPromptText
      ? LinkingUserPromptScreenText.toJSON(message.linkingUserPromptText)
      : undefined);
    return obj;
  },
...
function createBaseLinkingUserPromptScreenText(): LinkingUserPromptScreenText {
  return { title: "", description: "", linkButtonText: "", otherButtonText: "" };
}

export const LinkingUserPromptScreenText = {
  encode(message: LinkingUserPromptScreenText, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LinkingUserPromptScreenText {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): LinkingUserPromptScreenText {
    return {
      title: isSet(object.title) ? String(object.title) : "",
      description: isSet(object.description) ? String(object.description) : "",
      linkButtonText: isSet(object.linkButtonText) ? String(object.linkButtonText) : "",
      otherButtonText: isSet(object.otherButtonText) ? String(object.otherButtonText) : "",
    };
  },

  toJSON(message: LinkingUserPromptScreenText): unknown {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined && (obj.description = message.description);
    message.linkButtonText !== undefined && (obj.linkButtonText = message.linkButtonText);
    message.otherButtonText !== undefined && (obj.otherButtonText = message.otherButtonText);
    return obj;
  },

  create(base?: DeepPartial<LinkingUserPromptScreenText>): LinkingUserPromptScreenText {
    return LinkingUserPromptScreenText.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<LinkingUserPromptScreenText>): LinkingUserPromptScreenText {
    const message = createBaseLinkingUserPromptScreenText();
    message.title = object.title ?? "";
    message.description = object.description ?? "";
