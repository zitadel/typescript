...
export const AuthFactor = {
  ...
  toJSON(message: AuthFactor): unknown {
    ...
    message.otpSms !== undefined && (obj.otpSms = message.otpSms ? AuthFactorOTPSMS.toJSON(message.otpSms) : undefined);
    message.otpEmail !== undefined &&
      (obj.otpEmail = message.otpEmail ? AuthFactorOTPEmail.toJSON(message.otpEmail) : undefined);
    return obj;
  },
...
export const UserGrant = {
  ...
  fromJSON(object: any): UserGrant {
    return {
      ...
      grantedOrgDomain: isSet(object.grantedOrgDomain) ? String(object.grantedOrgDomain) : "",
    };
  },
  ...
  toJSON(message: UserGrant): unknown {
    ...
    message.grantedOrgDomain !== undefined && (obj.grantedOrgDomain = message.grantedOrgDomain);
    return obj;
  },
