...
import { SetRESTRequestResponse, SetRESTWebhook, Target } from "./target";
...
export const CreateTargetRequest = {
  encode(message: CreateTargetRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.restRequestResponse !== undefined) {
      SetRESTRequestResponse.encode(message.restRequestResponse, writer.uint32(26).fork()).ldelim();
    }
    if (message.timeout !== undefined) {
      Duration.encode(message.timeout, writer.uint32(34).fork()).ldelim();
    }
    if (message.isAsync !== undefined) {
      writer.uint32(40).bool(message.isAsync);
    }
    if (message.interruptOnError !== undefined) {
      writer.uint32(48).bool(message.interruptOnError);
    }
    return writer;
  },
...
export const UpdateTargetRequest = {
  encode(message: UpdateTargetRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.restRequestResponse !== undefined) {
      SetRESTRequestResponse.encode(message.restRequestResponse, writer.uint32(34).fork()).ldelim();
    }
    if (message.timeout !== undefined) {
      Duration.encode(message.timeout, writer.uint32(42).fork()).ldelim();
    }
    if (message.isAsync !== undefined) {
      writer.uint32(48).bool(message.isAsync);
    }
    if (message.interruptOnError !== undefined) {
      writer.uint32(56).bool(message.interruptOnError);
    }
    return writer;
  },
...
function createBaseSetExecutionRequest(): SetExecutionRequest {
  return { condition: undefined, targets: [], includes: [] };
}
